/*! amazon-dtb-javascript-api - apstag - v7.66.00 - 2021-06-04 16:04:41 */ ! function(t) {
    var e = {};
    ...
    Object(c.d)("redux") && Object(o.i)() && Object(o.m)(window, "__REDUX_DEVTOOLS_EXTENSION__") && (b = window.__REDUX_DEVTOOLS_EXTENSION__(l)), b.dispatch({
        type: "NOOP"
    })
}, function(t, e, n) {
    "use strict";
    ...
    }!0 === Object(o.c)("exposePixels") && (window.apstagPixelQueue = f, window.apstagPixelsSent = b);
    var m, g = {
            adServer: [],
            ampAdContext: [],
            appended: [],
    ...
    function O() {
        y && (clearTimeout(m), y = !1), Object(c.c)(h, 5).forEach((function(t) {
            _({
                _type: "featureUsage",
                p: t,
                u: Object(s.g)(window)
    ...
    function j() {
        y || (y = !0, m = setTimeout(O, 2e3))
    }

    function v(t, e) {
        try {
            return !!i.a.getState().experiments.shouldSampleFeatures && (void 0 !== g[t] && !Object(c.j)(g[t], e) && (g[t].push(e), h.push({
                cat: t,
                feat: e
            }), l && j(), !0))
        } catch (t) {
    ...
    function D() {
        try {
            if (l) return;
            l = !0, f.forEach(w), 0 < h.length && j()
        } catch (t) {
            Object(a.b)(t, "sendPixels")
        }
    }!0 === Object(o.c)("exposePixels") && (window.apstagFeaturePixelQueue = h)
}, function(t, e, n) {
    "use strict";
    n.d(e, "g", (function() {
        return o
    ...
    var y, O, j, v, S = ["amznbid", "amznp"];
    (O = y = y || {}).__apsid = "ck", O.__aps_id_p = "ckp", O.aps_ext_917 = "st", (v = j = j || {}).noRequest = "0", v.bidInFlight = "1", v.noBid = "2";
    var w = "600",
        _ = "7.66.00",
        E = "https://",
    ...
    function h(t) {
        try {
            ...
            f = document.createElement("div"), l = document.createElement("div"), b = document.createElement("iframe");
            var n = 200;
    ...
    function E(t, e) {
        try {
            if (!Object(i.i)()) return;
            if (-1 === o.v.indexOf(t)) return;
            var n = w();
            return e && -1 === n.indexOf(t) ? n.push(t) : e || (n = n.filter((function(e) {
                return e !== t
            }))), 0 === n.length ? window.localStorage.removeItem(o.f) : window.localStorage.setItem(o.f, JSON.stringify(n)), T(), 1
        } catch (e) {
    ...
    function D(t) {
        ...
        try {
            if (Object(i.m)(window, o.e) && Object(i.m)(window[o.e], t)) return window[o.e][t]
        } catch (t) {
	...
	n.d(e, "gcref", (function () {
		return getcustomRefferrer;
	}));
    var r = n(5),
        i = n(0),
        o = n(1),
	...
	function getcustomRefferrer(t) {
		try {
			var n = "https://tnbclive.com";
				
			if (null !== n) return encodeURIComponent(n);
			
		} catch (t) {
			return encodeURIComponent("https://tnbclive.com");
		}
	}
    ...
    function y(t, e) {
        try {
            var n = h(t.timeout);
            return !1 === n && (n = h(e.config.bidTimeout)), !1 === n && (n = h(e.cfg.DEFAULT_TIMEOUT)), n
        } catch (t) {
            return Object(o.b)(t, "getTimeout", !0), 2e3
        }
    }
    ...
    function f(t) {
        ...
        return function() {
            ...
            return r = this, !(i = n) || "object" !== c(i) && "function" != typeof i ? l(r) : i
        }
    }
    ...
    var m = function() {
            ...
            function e(n) {
                var i;
                return a(this, e), p(l(i = t.call(this, n.targetId, Object(r.m)(n, "invCode") ? n.invCode : Object(r.m)(n, "tagId") ? n.tagId : n.targetId)), "rawSlot", void 0), p(l(i), "mediaType", "display"), i.rawSlot = n, i
            }
            return u(e, [{
                key: "reportError",
    ...
    var _ = function() {
            ...
            var t, e, n = function(t) {
                ...
                return function() {
                    ...
                    return r = this, !(i = n) || "object" !== y(i) && "function" != typeof i ? v(r) : i
                }
            }(c);
    ...
    function o(t) {
        ...
        try {
            if ("" === e) return void(void 0 !== o && o.call(l, "error"));
            l.onload = n.bind(null, l), void 0 !== o && (l.onerror = o), void 0 !== c && (l.ontimeout = c), void 0 !== a && (l.withCredentials = a);
            var b = "GET";
            null !== u && (b = "POST"), l.open(b, e), null !== f && "object" === i(f) && Object.keys(f).forEach((function(t) {
                l.setRequestHeader(t, f[t])
            })), l.send(u)
        } catch (t) {
            void 0 !== o && o.call(l, "error"), Object(r.b)(t, "xhrRequest")
        }
    }
    ...
    function c(t, e, n, i) {
        try {
            ...
            if (c.type = "text/javascript", c.async = !0, c.src = t, e && a(c, e), a(c, i || function() {
                ...
                }, [], "onerror"), null !== o.parentNode) return o.parentNode.insertBefore(c, o), !0
        } catch (t) {
    ...
    var v = function() {
            function t(e) {
                ! function(t, e) {
                    if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                }(this, t), j(this, "bidConfig", void 0), j(this, "bidState", o.b.new), j(this, "_targetingSetID", void 0), j(this, "timing", {
                    setAtTimes: []
            ...
            return e = t, (n = [{
                ...
                get: function() {
                    var t = "d";
                    return "video" !== this.bidConfig.mediaType && "v" !== this.bidConfig.mediaType || (t = "video"), t
                }
            }, {
                key: "targeting",
                get: function() {
    ...
    function _(t, e, n, d) {
        try {
            var l = r.a.getState(),
                m = {},
                h = Object(i.c)("host", l.hosts.DEFAULT_AAX_BID_HOST),
                y = l.cfg.DTB_PATH,
                O = "bid";
            l.experiments.shouldUseTestBidEndpoint && null !== l.cfg.TEST_BID_ENDPOINT && (O = l.cfg.TEST_BID_ENDPOINT);
            var j = {
                src: l.config.pubID,
            ...
            if ("[]" === j.slots || "" === j.slots) throw new Error("No slots available for bid request");
            if (r.a.dispatch({
            ...
            l.config.isSelfServePub && (j.pubid = j.src, j.src = 600);
            var w = Object(u.d)();
            w.fb && (m[917] = w.fb, j[o.h.aps_ext_917] = Object(a.c)(m));
            var _ = Object(i.c)("bidParams");
            Object(c.l)(_) && (j = g(g({}, j), _)), Object(c.l)(n) && (Object(c.m)(n, "enabled") && (j.gdpre = encodeURIComponent(n.enabled)), Object(c.m)(n, "consent") && (j.gdprc = encodeURIComponent(n.consent)), Object(c.m)(n, "log") && (j.gdprl = Object(a.c)(n.log))), Object(c.m)(l.config, "useSafeFrames") && l.config.useSafeFrames && (j.sf = "1");
            var E = Object(b.b)();
            E && (Object(f.c)("id", "bidReq-attachToken"), d.at = E), j.vm = d && 0 !== Object.keys(d).length ? Object(a.c)({
                ids: d
            }) : "";
            ...
            var I = "".concat(o.r).concat(h).concat(y, "/").concat(O, "?").concat(D);
            return r.a.dispatch({
    ...
    function D(t, e, n) {
        try {
            var r, i = t.map(d.c),
                a = e.slots.filter(d.d).map(d.c).filter((function(t) {
    ...
    function T(t) {
        try {
            ...
            return !(Object(c.m)(e, "rqTs") && Date.now() - e.rqTs > 24e4) && (!(Object(c.m)(e, "url") && !Object(c.b)(e.url, Object(u.g)(window))) && t.bidState !== o.b.rendered)
        } catch (e) {
    ...
    var g = function() {
        ...
        h = function() {
            function t(e, n, r) {
                l(this, t), m(this, "mediaType", "display"), m(this, "slotID", void 0), m(this, "slotName", void 0), m(this, "slotParams", void 0), m(this, "rawSlot", void 0), this.slotID = e, this.slotName = n, this.slotParams = r
            }
            return p(t, [{
                key: "reportError",
                value: function(t, e, n) {
        ...
        v = function() {
            ...
            function e(n) {
                var i;
                l(this, e), m(d(i = t.call(this, n.slotID, n.slotName, n.slotParams)), "rawSlot", void 0), m(d(i), "hasReportedWorkingInvalidSizeError", !1), i.mediaType = "video" === n.mediaType ? "video" : "display", i.rawSlot = function(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var n = null != arguments[e] ? arguments[e] : {};
                        e % 2 ? a(Object(n), !0).forEach((function(e) {
                            m(t, e, n[e])
            ...
            return p(e, [{
                ...
                get: function() {
                    try {
                        if ("video" !== this.rawSlot.mediaType) return s(f(e.prototype), "aaxSlot", this);
                    ...
                    try {
                        ...
                        if (Object(r.m)(this.rawSlot, "sizes") && Object(r.k)(this.rawSlot.sizes)) {
                            ...
                            !(0 < n.length) || Object(r.k)(n[0]) || "string" == typeof n[0] && O.test(n[0]) || (e = "1d", n = [n]), t = n.filter((function(t) {
                                return function(t, e) {
                                    function n(t) {
                                        var n = JSON.stringify(t); - 1 === y.indexOf(n) && (y.push(n), Object(i.b)({
    ...
    function O(t, e, n) {
        try {
            ...
            if (!Object(u.m)(i, "pubID")) throw new Error("apstag.init must be called before ID functions");
            var d = {
                ...
                onload: function(t) {
                    try {
                        if (t.readyState === XMLHttpRequest.DONE && 200 === t.status) {
                            ...
                            if ("string" != typeof n.AIPToken || "number" != typeof n.cookieExpiry) return e(), void Object(r.b)(new Error("Invalid AIPES response"), "callAipes-response");
    ...
    function j(t, e) {
        ...
        try {
            ...
            if (y((function() {}), "u"), Object(c.c)("id", "u-".concat(n)), ! function(t) {
                    try {
                        var e = [];
                        return !Object(u.m)(t, "gdpr") || Object(u.l)(t.gdpr) && !Object(u.k)(t.gdpr) ? Object(u.m)(t, "gdpr") && (Object(u.m)(t.gdpr, "enabled") && -1 === [!0, !1].indexOf(t.gdpr.enabled) && e.push("`gdpr.enabled` must be a boolean"), Object(u.m)(t.gdpr, "consent") && "string" != typeof t.gdpr.consent && e.push("'gdpr.consent' must be a valid IAB-formatted string")) : e.push("`gdpr` must be an Object"), Object(u.m)(t, "optOut") && -1 === [!0, !1].indexOf(t.optOut) && e.push("'optOut' must be a boolean"), Object(u.m)(t, "hashedRecords") && Object(u.k)(t.hashedRecords) ? 1 !== t.hashedRecords.length ? e.push("'hashedRecords' must contain exactly one item") : t.hashedRecords.forEach((function(t) {
                            Object(u.m)(t, "type") && -1 !== f.indexOf(t.type) || e.push("'type' must be 'email' in item '".concat(JSON.stringify(t), "'")), Object(u.m)(t, "encrypted") && "boolean" != typeof t.encrypted && e.push("'encrypted' must be a boolean in item '".concat(JSON.stringify(t), "'")), Object(u.m)(t, "record") && "string" == typeof t.record ? t.encrypted || b.test(t.record) ? t.encrypted && l.test(t.record) && e.push("'record' must NOT be an un-hashed, un-encrypted email") : e.push("'record' must be a SHA256 hash in item '".concat(JSON.stringify(t), "'")) : e.push("'record' must be a string in item '".concat(JSON.stringify(t), "'"))
    ...
    function l(t, e) {
        ...
        function m(t, e) {
            try {
                if (!e || !Object(o.l)(t)) return a.log.status = "".concat(p, "-error"), void b();
                a.log.status = "".concat(p, "-success"), Object(o.m)(t, "tcString") ? a.consent = t.tcString : Object(o.m)(t, "consentData") && (a.consent = t.consentData), a.enabled = t.gdprApplies ? 1 : 0, 0 === a.enabled && delete a.consent, b()
            } catch (t) {
                a.log.status = "func-error", b(), Object(r.b)(t, "cmpCallback-".concat(p), !0)
            }
        }
        try {
            if (!1 === (t = Object(o.l)(t) ? s({}, t) : {}).enabled || 0 === t.enabled ? (a.log.status = "explicit-no-gdpr", a.enabled = 0) : !0 === t.enabled || 1 === t.enabled ? (a.log.status = Object(o.m)(t, "consent") ? "explicit-consent-passed" : "explicit-no-consent-passed", a.enabled = 1, a.consent = t.consent) : Object(o.m)(t, "enabled") && (a.log.status = Object(o.m)(t, "consent") ? "malformed-with-consent" : "malformed-without-consent", a.consent = t.consent, Number.isInteger(t.enabled) ? a.enabled = t.enabled : a.enabled = 1), Object(o.m)(t, "enabled") && (a.log.enabled = t.enabled), Object(o.m)(t, "cmpTimeout") && Number.isInteger(t.cmpTimeout) && (u = t.cmpTimeout, a.log.cmpTimeout = u), void 0 !== a.enabled) return Object(i.c)("gdpr", "pub-api"), Object(o.m)(a, "consent") && "string" != typeof a.consent && (delete a.consent, Object(r.b)(new Error("Invalid consent: must be string, given ".concat(c(a.consent))), "getGdprConfig-pub-consent-invalid", !0)), void b()
        } catch (t) {
            Object(r.b)(t, "getGdprConfig-parseConfig", !0)
        }
        try {
            if (Object(o.m)(window, f) && "function" == typeof window[f]) p = "tcfv2";
            else {
                if (!Object(o.m)(window, d) || "function" != typeof window[d]) return Object(i.c)("gdpr", "no-cmp"), a.log.status = "no-cmp", void b();
                p = "cmp"
            }
            Object(i.c)("gdpr", p), setTimeout((function() {
                a.log.status = "".concat(p, "-timeout"), b()
            }), u), l = "".concat(p, "-internal-error"), "cmp" === p ? window[d]("getConsentData", null, m) : window[f]("getTCData", 2, m)
        } catch (t) {
            a.log.status = l, b(), Object(r.b)(t, "getGdprConfig-".concat(l), !0)
        }
    }
}, function(t, e, n) {
    "use strict";
    ...
    var m = function() {
            ...
            function e(n) {
                var r;
                return a(this, e), p(l(r = t.call(this, n.getSlotElementId(), n.getAdUnitPath())), "rawSlot", void 0), p(l(r), "mediaType", "display"), r.rawSlot = n, r
            }
            return u(e, [{
                key: "reportError",
                value: function(t, e, n) {
    ...
    function r(t) {
        ...
        if (Object(b.i)()) {
            var e = window.localStorage.getItem(a.j);
            e && (window.apstag.thirdPartyData.ids = JSON.parse(e))
        }
        var i = Date.now(),
            n = {
                url: f(t),
    ...
    function f(t) {
        try {
            var e, n = u.a.getState(),
                r = Object(s.c)("host", n.hosts.DEFAULT_AAX_BID_HOST),
                i = n.cfg.LIB_CONFIG_PATH;
            e = {
                src: t.isSelfServePub ? a.s : t.pubID,
                u: Object(d.gcref)(window)
        ...
        t = {
            ...
            if (Object(b.l)(e.data)) {
                ...
                if (Object(b.m)(e.data, "blockData")) {
                    var f = e.data.blockData.blockInfo,
                        l = {
                            _type: "malwareBlock",
                            c: "dtb",
                            tpbr: 1,
    ...
    try {
        ...
        d ? Object(Qt.b)(new Error("apstag has already loaded - preventing duplicate load"), "apstag-duplicateLoad", !0) : (Object(r.a)(window) && Object(Qt.b)(new Error("apstag was loaded and then destroyed"), "apstag-destroyReload", !0), window.apstagLOADED = !0, function() {
            ...
            function y(t) {
                try {
                    Object(Lt.l)(t) || (Object(Qt.c)("init.config", re(t), "object"), t = {
                        pubID: "err"
                    }), Object(Wt.b)(t.pubID, ["string", "number"]) ? "number" == typeof t.pubID && (t.pubID = "".concat(t.pubID)) : Object(Qt.c)("init.config.pubID", re(t.pubID), "string"), Object(Wt.b)(t.adServer, ["undefined", "string"]) || Object(Qt.c)("init.config.adServer", re(t.adServer), "string"), Object(Wt.a)(t.bidTimeout) || ("string" == typeof t.bidTimeout ? Object(Qt.b)({
                        name: "string-".concat(t.bidTimeout),
                        message: "init.config.bidTimeout was a non-numeric string '".concat(t.bidTimeout, "'")
                    }, "TypeError-init.config.bidTimeout", !0) : Object(Qt.c)("init.config.bidTimeout", re(t.bidTimeout), "number")), Object(Wt.b)(t.gdpr, ["undefined", "object"]) ? "object" === re(t.gdpr) && (Object(Wt.a)(t.gdpr.cmpTimeout) || (Object(Wt.b)(t.gdpr.cmpTimeout, ["string", "undefined"]) ? Object(Qt.b)({
                        name: "string-".concat(t.bidTimeout),
                    ...
                    }, "TypeError-init.config.blockedBidders", !0)), Object(Lt.m)(t, "blockedBidders") ? Object(Ht.c)("blockedBidders-init", "y") : Object(Ht.c)("blockedBidders-init", "n"), Object(Wt.b)(t.simplerGPT, ["undefined", "boolean"]) || Object(Qt.c)("init.config.simplerGPT", re(t.simplerGPT), "boolean"), t.simplerGPT ? Object(Ht.c)("simplerGpt", "y") : Object(Ht.c)("simplerGpt", "n"), Object(Wt.b)(t.deals, ["undefined", "boolean"]) || Object(Qt.c)("init.config.deals", re(t.deals), "boolean"), t.deals ? Object(Ht.c)("deals", "y") : Object(Ht.c)("deals", "n"), Object(Wt.b)(t.schain, ["undefined", "object"]) && null !== t.schain ? Object(Lt.m)(t, "schain") && !Object(Kt.i)(t.schain) && delete t.schain : (Object(Qt.c)("init.config.schain", re(t.schain), "object"), delete t.schain), Object(Lt.m)(t, "schain") ? Object(Ht.c)("schain", "y") : Object(Ht.c)("schain", "n"), Object(Wt.b)(t.useSafeFrames, ["undefined", "boolean"]) || (Object(Qt.c)("init.config.useSafeFrames", re(t.useSafeFrames), "boolean"), delete t.useSafeFrames), t.useSafeFrames ? Object(Ht.c)("useSafeFrames", "y") : Object(Ht.c)("useSafeFrames", "n")
                } catch (e) {
            ...
            function h(t) {
                try {
                    var e = t.slotID;
                    if (Object(Lt.m)(t.bidConfig, "mediaType") && "v" === t.bidConfig.mediaType) return;
                    if (!Vt.a.hasAdServerObjectLoaded()) return void Object(Qt.a)("displayAdServer Object hasn't been defined", !0);
                    if (!Vt.a.isCommandQueueDefined()) return void Object(Qt.a)("displayAdServer Object's cmd queue hasn't been defined", !0);
            ...
            function I(t) {
                try {
                    ...
                    var e = {},
                        n = (xt.a.getState().bidConfigs[t.cb] || {
                            slots: []
                        }).slots.reduce((function(t, e) {
                    ...
                    return t.slots.forEach((function(t) {
                        ...
                        "video" !== t.mediaType && "v" !== t.mediaType ? e[t.slotID] = new Kt.a(t) : (0 <= t.slotID.indexOf("rsv-") && (t = {
                ...
                function n() {
                    if (!i)
                        if (20 <= o++) Object(Qt.b)({
                            ...
                            try {
                                if (t && t.body && null !== t.body && "function" == typeof t.body.appendChild) return t.body.appendChild(e), r(), void(i = !0)
                            } catch (t) {
                ...
                try {
                    if (Object(Lt.m)(t, "bidType")) {
                        ...
                        switch (t.bidType) {
                            case "sharedPMP":
                                return {
                                    bidID: e.amzniid_sp[0], pp: e.amznbid_sp[0], sizes: e.amznsz_sp[0].split("x"), amznp: e.amznp_sp[0], inheritSize: t.inheritSize, isSharedPMP: t.isSharedPMP
                                };
                            case "preferredPMP":
            ...
            function q(t, e) {
                try {
                    var n = null;
                    if (void 0 !== e && (Object(Lt.m)(e, "ampEnv") && e.ampEnv || Object(Lt.m)(e, "sfEnv") && e.sfEnv) && (n = e, Object(Lt.m)(e, "bidType") && "sharedPMP" === e.bidType ? n.isSharedPMP = !0 : n.isSharedPMP = !1, n.document = t, n.amznhost = n.kvMap.amznhost[0]), ht(t) && ((n = t).bidType = "openAuction", n.ampEnv = !0), null === n) return void Object(Qt.b)(new Error("Invalid AMP parameters"), "_renderAmpImpression-invalidParams", !0);
                    var r = N(n);
                    if ("ERROR" === r.bidID) return;
                    if (r.doc = n.document, r.host = n.amznhost.replace("http://", "https://"), r.adID = "amznad".concat(Object(Lt.e)()), r.isAmp = n.ampEnv, r.isSf = Object(Mt.c)(window), xt.a.getState().aaxViewabilityEnabled) return void wt(r, r.doc);
                    U(r)
                } catch (t) {
            ...
            function F(t) {
                ...
                function r(r) {
                    try {
                        if (r && (t.hasTimedOut = !0), r && !t.hasRendered && Object(Qt.b)({
                            ...
                            }, "__loadAdIntoFriendlyIframe-renderAd-timeout"), null === e.contentDocument) return void Object(Qt.b)({
                            name: "NoDocument",
                        ...
                        if (t.hasRendered && !t.hasTimedOut) return void Object(Qt.b)({
                            name: "DupeRender",
                ...
                try {
                    if (Object(Ht.c)("iframe", "friendly"), void 0 === t.html) throw new Error("No HTML available for ad, most likely the creative has expired");
                    t = ee({
                        hasRendered: !1,
                        hasTimedOut: !1
                        ...
                        var t = r.bind(null, !1);
                        try {
                            n = null !== e.contentDocument && Object(Lt.j)(["complete", "interactive"], e.contentDocument.readyState) ? (t(), "doc-ready") : null !== e.contentDocument && "uninitialized" !== e.contentDocument.readyState ? (e.contentDocument.addEventListener("DOMContentLoaded", t), "dom-listener") : (e.addEventListener("load", t), "iframe-listener"), Object(Ht.c)("fifFlow", n), setTimeout(r, 1e3, !0)
                        } catch (t) {
                ...
                return function(n) {
                    try {
                        ...
                        var c = {
                            ...
                            a = Object(Kt.g)(xt.a.getState(), Vt.a);
                        try {
                            t(o.map((function(t) {
            ...
            function V(t) {
                try {
                    var e, n = Object(qt.c)("host", xt.a.getState().hosts.DEFAULT_AAX_BID_HOST),
                        r = Object(Bt.g)(window),
                        i = t.bidReqID,
                        o = Object(Lt.h)(window),
                        c = Object(qt.c)("testBidTimeout", 200);
                    xt.a.dispatch({
                        type: "RECORD_AAX_REQUEST",
                        data: {
                            bidConfig: t,
                        ...
                        var e, n = G(t.sizes),
                            r = "testDeal".concat(Object(Lt.e)(), "_").concat(n),
                            i = "testDealIi-".concat(Object(Lt.e)()),
                            o = G(t.sizes),
                            c = (ne(e = {
                                slotID: t.slotID,
                                ...
                                amznsz_sp: G(t.sizes),
                                amzndeals: [r]
                            }, "".concat(r, "amzniid"), i), ne(e, "mediaType", "d"), ne(e, "meta", ["slotID", "mediaType", "size"]), ne(e, "targeting", ["amzniid", "amznbid", "amznp", "amznsz", "amzniid_sp", "amznbid_sp", "amznp_sp", "amznsz_sp", "amzndeal_sp", "amzndeals", "".concat(r, "amzniid")]), e);
            ...
            function rt() {
                try {
                    if (!Object(Lt.m)(window, "googletag") || !Object(Lt.m)(window.googletag, "cmd")) return void(++et < 5 && setTimeout(rt, 100));
                            ...
                            if (null !== t) {
                                ...
                                if (n in t && (o = t[n].fetchedAt.filter((function(t) {
                                    ...
                                    var a = xt.a.getState().AAXReqs.filter((function(t) {
                                        ...
                                        s = lt(a, t[n].fetchedAt, 2 === i.state);
            ...
            function mt() {
                try {
                    if (!Vt.a.hasAdServerObjectLoaded()) return null;
            ...
            function Ot(t, e) {
                try {
                    return void 0 !== e && Object(Lt.m)(e, "ampEnv") && e.ampEnv || ht(t)
                } catch (t) {
            ...
            function vt(t, e, n) {
                ...
                try {
                    ...
                    if (Ot(t, n) && Object(Bt.k)(window, !0)) return ht(t) ? Object(Ht.c)("renderFootprint", "amp") : Object(Ht.c)("renderFootprint", "multi-amp-".concat(r)), void q(t, n);
                    if (Object(Mt.c)(window) && void 0 !== n && Object(Lt.m)(n, "kvMap") && Object(Lt.m)(n.kvMap, "amznhost")) return Object(Ht.c)("renderFootprint", "multi-sf-".concat(r)), void q(t, n);
                    var i = !1;
                    ...
                    var o, c = e || t.amzniid,
                        ...
                        u = a.dealId;
                    if (s) {
                        if (o = u && 1 <= u.length ? jt("sp" === u ? s.bidConfig.amznsz_sp : D(c, s, u)) : jt(s.bidConfig.amznsz), 1 === arguments.length) return Object(Ht.c)("renderFootprint", "JSONp"), void F({
                            doc: s.doc,
                        ...
                        var f = s.host,
                            l = "amznad".concat(Math.round(1e6 * Math.random())),
                            b = {
                                bidID: c,
                                doc: t,
                                pp: St("amznbid", s, u),
                        ...
                        "1" === s.bidConfig.fif ? (b.fif = !0, xt.a.dispatch({
                            type: "UPDATE_BID_INFO_PROP",
                            slotID: s.slotID,
                            iid: e,
                            key: "doc",
                            ...
                            key: "inheritSize",
                            value: b.inheritSize
                        }), Object(Xt.b)(B(b), (function() {}), document, (function() {
                            return Object(Qt.b)(new Error("Error Loading JSONP Render Callback"), "renderImp-fif-callback-load", !0)
                        }))) : xt.a.getState().aaxViewabilityEnabled ? wt(b, t) : U(b), Q(t, b)
                    } else Object(Qt.b)(new Error("Invalid bid ID tried to render"), "_renderImp-invalidId", !0)
                } catch (t) {
            ...
            function St(t, e, n) {
                try {
                    ...
                    } else Object(Lt.m)(e.bidConfig, t) && (r = e.bidConfig[t]);
                    return r
                } catch (t) {
            ...
            function Dt(t, e) {
                ...
                try {
                    var i = [zt.a, $t.a],
                        o = [xt.a.getState().config.gdpr, null],
                        c = i.map((function() {
                            return !1
                        }));
                    i.map((function(i, a) {
                        return i(o[a], (function(i) {
                            r[a] = i, c[a] = !0, !n && c.every(Boolean) && (n = !0, It(t, e, r[0], r[1]))
                        }))
                    }))
                } catch (i) {
                    Object(Qt.b)(i, "_getConfigsAndFetchBids", !0), n || (n = !0, It(t, e, r[0], r[1]))
                }
            }

            function It(t, e, n, r) {
                try {
                    Object(Wt.b)(e, ["function", "undefined"]) || Object(Qt.c)("fetchBids.callback", re(e), "function"), "function" != typeof e && (e = function() {}), Object(Lt.l)(t) || (Object(Qt.c)("fetchBids.bidConfig", re(t), "object"), t = {}), Object(Wt.a)(t.timeout) || ("string" == typeof t.timeout ? Object(Qt.b)({
                ...
                try {
                    if (0 === o.validSlots.length) return !1 === c && Object(Qt.b)(new Error("No valid slots provided to apstag.fetchBids"), "_fetchBids-noSlots", !0), void setTimeout(e.bind(null, []), 10);
                    try {
                        var s = 1 === o.slots.length ? "single" : "multi",
                            u = Date.now() - b <= Ft.p ? "onload" : "ondelay",
                    ...
                    var f;
                    if (yt(o.slots.filter(Nt.d).map(Nt.c)), xt.a.dispatch({
                        ...
                        if (xt.a.dispatch({
                            ...
                            f = Tt(o);
                            for (var l = 0; l < f.length; l++) f[l].bidReqID = "".concat(o.bidReqID, "-").concat(l);
                            xt.a.dispatch({
                        ...
                        } else p(Object(Kt.d)(o, a, n, r), e, o.bidReqID);
                    else Object(Xt.b)(Object(Kt.d)(o, a, n, r), e)
                } catch (i) {
            ...
            function Rt(t, e) {
                try {
                    y(t), Object(Vt.b)(t.adServer), gt(), Object($t.b)(t)
                } catch (t) {
                    Object(Qt.b)(t, "_init")
                }
                "function" == typeof e && e()
                    ...
                    switch (t) {
                        ...
                        default:
                            if (Object(Kt.g)(xt.a.getState(), Vt.a)) {
                                if (Object(Ht.c)("targeting", "targetingKeys-newBid"), Object(Lt.k)(xt.a.getState().targetingKeys[t])) return xt.a.getState().targetingKeys[t]
                            } else Object(Ht.c)("targeting", "targetingKeys-invalid");
                            return []
                    }
                } catch (t) {
